...
| FLAC      | yes     | n/a     | yes (RFC 9639, up to 8 channels, 8 / 16 / 20 / 24 / 32-bit, sample rates up to 192 kHz, fixed + variable blocksize; decode-only this round, encoder ships next) |
...
| FLAC         | done (round 10)     | available (encoder ships next round, macOS 13+) |
